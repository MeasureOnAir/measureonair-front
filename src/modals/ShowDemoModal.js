...
const ShowDemoModal = ({ openShowDemoModal, setOpenShowDemoModal }) => {

  return (
    <div>
      <Transition.Root show={openShowDemoModal} as={Fragment}>
        <Dialog
          as="div"
          className="fixed z-10 inset-0 overflow-y-auto"
          onClose={setOpenShowDemoModal}
        >
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 w-100 h-100">
            <Transition.Child
              as={Fragment}
