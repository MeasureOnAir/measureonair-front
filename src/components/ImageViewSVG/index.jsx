...
import NewMarkerModal from "../../pages/viewer/NewMarkerModal";
import useGenerateId from "../../hooks/utils/useGenerateId";
...
export default function App({
  ...
  const generateMarkerId = () => {
    ...
    if(Object.keys(markers).length > 0) {
      ...
      console.log('lastMarkerId', lastMarkerId)
    }
  ...
  return (
    <div style={{ width: "100%", height: "100%", backgroundColor: "black" }}>
      {/* <button onClick={() => console.log(window.innerWidth)} style={{color:"white"}}>TEXT</button> */}
      {
